...
namespace radiosity
{
	...
	{
		demo_geometry::skyPatch->_emission = new radiosity_structs::light(1.0, 1.0, 1.0);
		demo_geometry::skyPatch->_excident = demo_geometry::skyPatch->_emission;
		demo_geometry::bottomPatch->_excident = demo_geometry::bottomPatch->_emission;
		demo_geometry::leftPatch->_excident = demo_geometry::leftPatch->_emission;
		demo_geometry::rightPatch->_excident = demo_geometry::rightPatch->_emission;
		demo_geometry::backPatch->_excident = demo_geometry::backPatch->_emission;
	}
	...
	{
		enter_patch_quads_wireframe_overlay(p);
